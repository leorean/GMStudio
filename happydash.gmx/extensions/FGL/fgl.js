...
function FGLImplementationTestingSDK() {
  ...
  self.loadScores = function(leaderboardId) {
      ...
      var scoresStr = localStorage['lb.' + self.gameId.toString() + '.' + leaderboardId.toString()];
      if (scoresStr == null || scoresStr == '') {
          scoresStr = localStorage["lb." + self.gameId]; // Legacy compatibility
          if (scoresStr == null || scoresStr == '') {
              return [ ];
          }
      }
  ...
  self.saveScores = function(scores, leaderboardId) {
      ...
      localStorage['lb.' + self.gameId.toString() + '.' + leaderboardId.toString()] = JSON.stringify(scores);
  };
  
  self.loadAchievements = function() {
      var achievementsStr = localStorage['lb.' + self.gameId.toString() + '.achievements'];
  ...
  self.saveAchievements = function(achievements) {
      localStorage['lb.' + self.gameId.toString() + '.achievements'] = JSON.stringify(achievements);
  }
